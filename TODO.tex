...
% Glossar: Virtual Appliances: also in virtuelle Instanzen eingebettete Anwendungen .
% Fork Bomb: die die Ressourcen eines Systems erschöpfen, indem sie als Programm rekursiv Kopien von sich selbst in einer Endlosschleife erzeugen
% Immutable infrastructure (docker einleitung bei CI und CD) ... http://blog.tutum.co/2015/06/02/immutable-infrastructure-and-containers/ .... http://unikernel.org/blog/2015/unikernels-meet-docker/
