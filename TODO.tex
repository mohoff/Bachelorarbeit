...
% cahpter* anstatt chapter ?

% sicherstellen dass unternehmsnahmen einheitlich regular oder kursiv sind.. google, ibm, hp, docker

% Linux security/lsm namespace: https://lwn.net/Articles/623575/

% reformat chapter style with package titlesec
%\titleformat{\section}
%{\filcenter\normalfont\Large\bfseries}
%{\chaptertitlename~\thechapter} {0.5em} {}

% fuer jeden github-repo link einen author finden. commited lines finden und hauptcontributor mit author="" angeben.

% Sicherstellen, dass Abschnitt und Kapitel korrekt verwendet wurden
