...
\label{secLinux}
	...
	% TODO: Grober Überblick geben, sodass klar wird, dass Namespaces und Cgroups Kernbestandteil von Begriff/Sache "Container" sind, un ein Containerkonzept erst überhaupt realisierbar machen. Isolations- und Ressourcenverwaltungsmechansimen, die für Container obligatorisch sind.
	% LSMs, MACs, Capabilities sind eher optional (werden für den reinen Containerbetreib nicht benötigt), ergaenzend zu nativer Linux-DAC, stellen aber für die Sicherheit wichtige Methoden bereit, um Container und Hosts auf verschiedene Arten, auch mehrschichtig, zu schützen.
	% Evtl. Referenz auf "defense in depth", "principle of least privlege"
	% --------------------------------------------------------------------------------------
