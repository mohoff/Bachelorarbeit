  ...
  \section{Einschränkungen von Zugriffsrechten}
    ...
    \subsection{Linux Security Modules (\acrshort{LSM}s) und Mandatory Access Control (\acrshort{MAC1})}
      	...
      	% Macht Sinn das erst am Ende zu machen, wenn noch Zeit ist. Weil SELinux im Detail mehr Exkurs wird.
				...
				Auf Konzeptebene basiert der Schutz auf der Implementierung einer feingranularen und flexiblen MAC.
				...
				Unter Docker können die vier Label-Attribute pro Container als Parameter für den \texttt{run}-Befehl manuell spezifiziert werden \cite{dockerRun}.
