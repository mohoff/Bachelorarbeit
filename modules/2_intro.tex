...
\label{intro}
  ...
  Container sind in Infrastrukturen, in denen es auf Skalierbarkeit ankommt, trotz Sicherheitsbedenken beliebt. Vor allem "Multi-Tenant" Services werden gerne mit Docker eingesetzt.
    ...
    \subsection{Hypervisor-basierte Virtualisierung}
      ...
      Bekannte Vertreter von Hypervisorn sind die kommerziellen \emph{ESXI} der Firma VMware und \emph{Hyper-V} von Mircosoft, sowie die Open-Source Hypervisor \emph{Xen} und \emph{KVM} \cite[S.1]{dockerLXCKub}.
      %TODO: mehr Quellen
