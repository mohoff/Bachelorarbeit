...
\pagenumbering{arabic}
  ...
  \section{Struktur der Arbeit}
    ...
    \begin{enumerate}
      \item Sicherheitsfunktionen, die der Linux-Kernel anbietet und teils obligatorisch von Docker eingesetzt werden. Darunter fallen Techniken zur Isolierung, Ressourcen- und Rechteverwaltung von Containern sowie Methoden, um das Hostsystem mit zusätzlichen Linux Sicherheitsfeatures abzusichern.
      \item Sicherheit im Docker-Ökosystem, also z.B.
        \begin{itemize}
        ...
        \end{itemize}
      \item Sicherheit von Docker in Cloud-Infrastrukturen
    \end{enumerate}
