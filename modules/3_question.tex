...
\label{question}
  ...
  \begin{itemize}
    \item \textbf{Administrative Kontrollen:} Enthält Management-Kontrollen, die z.B. durch die Entwicklung einer Sicherheitspolitik, Best Practices oder Sicherheitsschulungen des Personals, umgesetzt werden.
