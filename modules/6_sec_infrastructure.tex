...
\label{secInfrastructure}
  ...
  \label{privateCloud}
    ...
    Durch die Vielseitigkeit und Komplexität von \emph{OpenStack}, wird der Technologie nachgesagt, ... % schwierig zu isntallieren/betreiben zu sein.
    ...
    % ) How is Magnum is different from Nova?
    ...
    % Von openSuSe genutzt bzw. Angebot von enterprise loesungen auf der basis von open stack. .... suse cloud
    % https://www.suse.com/products/suse-openstack-cloud/

    % http://platform9.com/why-platform9/
    % ( http://www.wavemaker.com/cloud/ )

    % https://wiki.openstack.org/wiki/Magnum
    % http://www.heise.de/newsticker/meldung/OpenStack-goes-Container-2660052.html
    ...
    % OpenStack: besteht aus sehr vielen Komponenten. Komplexe Software, deren Einarbeitung sich lohnen kann
    % http://www.openstack.org/software/

    % Bisher Docker-Support als Treiber/Erweiterung des Moduls Nova
