...
\label{secInfrastructure}
  ...
  \label{privateCloud}
    ...
    % TODO: Docker sehr gut geeignet fuer Private Clouds... mehr Bezug zu Docker noch hier rein
    ...
    \subsection{Beispiel: OpenStack}
      ...
      % TODO: https://docs.docker.com/machine/drivers/openstack/
      % TODO: Mit integrieren in dieses Kaptiel: \cite{IBMDockerOpenStack}
