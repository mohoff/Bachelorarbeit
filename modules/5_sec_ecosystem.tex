...
\label{secEcosystem}
  ...
  \section{Security Best-Practises}
    ...
    \subsection{Datencontainer}
      ...
      Z.B. wird von \emph{Docker} empfohlen, eigene Datencontainer zu betreiben, die den Zustand von Anwendungen auf Datenebene speichern. Diese Art von Containern kann als deren Lifecycle unabhängig von Servicecontainern verwaltet werden kann.
      % DO
